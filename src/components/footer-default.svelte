...
<footer class="bg-light px-4 pt-8 pb-12">
  <div class="sm:max-w-[800px] sm:mx-auto">
    <p class="text-sm">
      制作者: 楠本輝也
    </p>
    ...
    <div class="mt-6">
      <a href="https://github.com/teru1116/sun-teru-invitation" target="_blank" class="inline-block">
    ...
    <p class="mt-4 text-xs text-textGray">
      ©︎ おてる All Rights Reserved.
    </p>
  </div>
</footer>