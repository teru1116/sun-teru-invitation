...
<form>
  ...
  <fieldset class="required">
    <legend>電話番号</legend>
    <input type="tel" name="電話番号" placeholder="09012345678" required bind:value={phoneNumber}>
  </fieldset>

  <fieldset class="required">
    <legend>メールアドレス</legend>
    <input type="email" name="email" placeholder="example@gmail.com" autocomplete="email" required bind:value={email}>
  </fieldset>

  <fieldset class="required">
    <legend>誕生日</legend>
    <input type="email" name="email" placeholder="11月16日" autocomplete="email" required bind:value={birthday}>
  </fieldset>
